...
T_flat_array = np.linspace(0,150,151)
T_gate_array = T_flat_array + 2*width
...
# np.savetxt(fname+'_leakage21.txt',leakage21_array)
# np.savetxt(fname+'_leakage20.txt',leakage20_array)
# '''
leakage21_array = np.genfromtxt(fname+'_leakage21.txt')
leakage20_array = np.genfromtxt(fname+'_leakage20.txt')

leakage_fig = plt.figure(figsize=(16, 9))
plt.plot(T_flat_array, leakage21_array, '-h', label = r'$P_{|21\rangle}$')
plt.plot(T_flat_array, leakage20_array, '-s', label = r'$P_{|20\rangle}$')
plt.plot(T_flat_array, leakage21_array+leakage20_array, '-d', label = r'$P_{|20\rangle}+P_{|21\rangle}$')
plt.xlabel('Flat top (ns)')
plt.ylabel(r'$P_{|21\rangle,|20\rangle}$ at end of pulse')
plt.xlim([T_flat_array[0], T_flat_array[-1]])
